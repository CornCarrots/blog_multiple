$(
    function () {
        var managers = {
            ...
            key: '',
            managers: [],
            manager: {id:0,name:'',password:'',salt:'',nickName:'',sex:0,mobile:'',email:'',createDate:null,status:1},
            manager_role: {},
            password: '',
            rids: [],
            allRoles: []
        ...
        var managerVue = new Vue(
            {
                ...
                methods: {
                    ...
                    addButton: function () {
                        managerVue.manager = {id:0,name:'',password:'',salt:'',nickName:'',sex:0,mobile:'',email:'',createDate:null,status:1};
                        managerVue.password = '';
