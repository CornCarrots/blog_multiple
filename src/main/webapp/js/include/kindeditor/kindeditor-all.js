...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&orderItem=' + order + '&dir=' + dirName;
 ...
 *   since many of the settings need to be passed to Flash in orderItem to take
 *   effect.
 * *********************** */
...
/* *******************************
	...
	This ensures that events are executed in a determinate orderItem and that
