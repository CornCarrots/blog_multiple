...
import com.lh.blog.filter.URLPathMatchingFilter;
import com.lh.blog.realm.DatabaseRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        shiroFilterFactoryBean.setLoginUrl("/back");
        // 登录成功后要跳转的链接
        ...
        filterChainDefinitionMap.put("/applySuccess", "anon");
        ...
        filterChainDefinitionMap.put("/noticeList", "anon");
        ...
        filterChainDefinitionMap.put("/history", "anon");
        filterChainDefinitionMap.put("/setting", "anon");
